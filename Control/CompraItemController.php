...
class CompraItemController
{
    ...
    private function cargarObjeto($param)
    {
        ...
        if (array_key_exists('idCompraItem', $param) and array_key_exists('idProducto', $param) and array_key_exists('idCompra', $param) and array_key_exists('compraItemCantidad', $param)) {
            $objCompraItem = new CompraItem();
            $objCompraItem->setear($param['idCompraItem'], $param['idProducto'], $param['idCompra'], $param['compraItemCantidad']);
        }
