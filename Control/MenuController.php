...
class MenuController{
    ...
    private function cargarObjeto($param){
        ...
        if(array_key_exists('menuNombre',$param) and array_key_exists('menuDescripcion',$param)){
    ...
    public function deshabilitar($param){
        ...
        $objMenu->setmenuDeshabilitado($fechaStamp);
        if ($objMenu != null and $objMenu->modificar()) {
            $resp = true;
        }
        return $resp;
    ...
    public function habilitar($param){
        ...
        $objMenu->setmenuDeshabilitado('habilitar');
        if ($objMenu!= null and $objMenu->modificar()) {
            $resp = true;
        }
        return $resp;
