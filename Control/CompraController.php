...
class CompraController
{
    ...
    private function cargarObjeto($param)
    {
        ...
        if (array_key_exists('idCompra', $param) and array_key_exists('fechaCompra', $param) and array_key_exists('idUsuario', $param)) {
            $objCompra = new Compra();
            if(!$objCompra->setear($param['idCompra'], $param['fechaCompra'], $param['idUsuario'])){
                $objCompra = null;
            }
        }
        return $objCompra;
