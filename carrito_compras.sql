...
CREATE TABLE IF NOT EXISTS `compraestado` (
  ...
  `compraEstadoFechaIni` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `compraEstadoFechaFin` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  `productoNombre` varchar(30) NOT NULL,
  `productoCantStock` int(11) NOT NULL,
  `productoPrecio` int(11) NOT NULL,
  `productoUrlImagen` varchar(200) NOT NULL,
  PRIMARY KEY (`idProducto`),
  UNIQUE KEY `idproducto` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO `producto` (`idProducto`, `productoNombre`, `productoCantStock`, `productoPrecio`, `productoUrlImagen`) VALUES
(1, 'ROGER WATERS EL CEREBRO DE PINK FLOYD', 5, 13416, "https://www.disqueriamusicshop.com/files/products/654c6828f08fd-1369367-2.jpg"),
(2, 'LA MUJER QUE SOY', 10, 9360, "https://www.disqueriamusicshop.com/files/products/654c6828881e6-1369366-3.jpg"),
(3, 'GRITOS DE NEON', 1, 6448, "https://www.disqueriamusicshop.com/files/products/654c68278885a-1369365-3.jpg"),
(4, 'BEYOND THE STORY', 3, 15600, "https://www.disqueriamusicshop.com/files/products/654c6826de828-1369364-3.jpg"),
(5, 'ALGUN TIEMPO ATRAS LA VIDA DE GUSTAVO CERATI', 8, 16640, "https://www.disqueriamusicshop.com/files/products/654c6826651b4-1369363-3.jpg"),
(6, 'ESPEJISMOS', 9, 10285, "https://www.disqueriamusicshop.com/files/products/6549c526cd6dc-1369362-3.jpg"),
(8, 'DARK SIDE OF THE MOON', 6, 34894, "https://www.disqueriamusicshop.com/files/products/65408b6c4e825-1362799-3.jpg"),
(9, 'BBC SESSIONS USA IMPORT', 1, 42896, "https://www.disqueriamusicshop.com/files/products/61e78ce66d60b-1257852-3.jpg"),
(10, 'NIGHT IN BUENOS AIRES 180G USA IMPORT', 10, 38186, "https://www.disqueriamusicshop.com/files/products/61e8de5185b22-1256439-3.jpg"),
(11, 'BUENOS MUCHACHOS', 2, 23936, "https://www.disqueriamusicshop.com/files/products/60c18e670dcec-1235104-3.jpg"),
(12, 'CHANGES COLORED VINYL GATEFOLD', 6, 47289, "https://www.disqueriamusicshop.com/files/products/5eb1ca34c94e5-1164948-3.jpg");
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `usuarioMail` varchar(50) NOT NULL,
  `usuarioDeshabilitado` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idUsuario`),
  UNIQUE KEY `idusuario` (`idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `usuario` (`idUsuario`, `usuarioNombre`, `usuarioPass`, `usuarioMail`, `usuarioDeshabilitado`) VALUES
