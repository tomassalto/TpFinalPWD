    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow rounded p-3 mb-2 bg-dark">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="col needs-validation" method="post" action="../Accion/IniciarSesion.php" novalidate>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nombre" name="usuarioNombre" required placeholder="Usuario">
