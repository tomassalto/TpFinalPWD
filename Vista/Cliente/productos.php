...
?>
        <div class="">
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form method="post" action="../../Vista/Admin/Accion/registrarse.php" class="needs-validation" novalidate>
                                                ...
                                                <table id="lista__carrito" class="table table-dark">
                                                    ...
                                                    if ($arrayCompraItem != null) {
                                                        foreach ($arrayCompraItem as $compraItem) {
                                                            echo '
                                                    <tr>
                                                        <td class="col-md-2"><img src="' . $compraItem->getObjProducto()->getproductoUrlImagen() . '" class="img-thumbnail"></td>
                                                        <td>' . $compraItem->getObjProducto()->getproductoNombre() . '</td>                                                        
                                                        <td>' . $compraItem->getObjProducto()->getproductoPrecio() . '</td>
                                                        <td>' . $compraItem->getcompraItemCantidad() . '</td>
            ...
            <div class="container d-flex align-items-center justify-content-end">
                ...
                <div id="content__carrito" class="text-end">
                    <a class="link-light" data-bs-toggle="modal" href="#exampleModalToggle2" role="button">
                        <img id="logo_carrito" src="../img/icons8-carrito-de-compras-96.png" alt="Logo de Carrito">
                    </a>
                </div>
            </div>
            ...
            <div class="tarjetas-productos" onclick="verDetalle(this)">
                <a class="link-light" data-bs-toggle="modal" href="#exampleModalToggle1" role="button">
                    <div class="tarjeta-producto__imagen">
                        <img class="foto__producto" src="' . $producto->getproductoUrlImagen() . '" alt="">
                    </div>
                    <div class="tarjeta-producto__info">
                        <p class="nombre__producto">' . $producto->getproductoNombre() . '</p>                        
                        <span class="precio__producto d-none" data-precio="' . intval($producto->getproductoPrecio()) . '"></span>

                        <span class="stock d-none">' . $producto->getproductoCantStock() . '</span>
