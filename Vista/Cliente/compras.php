...
if($objSession->getVista()!=NULL){
    if ($objSession->getVista()->getIdRol() == 2) {
        ...
        if ($arrayCompra != null) {
            ...
            // print_r($arrayComprasRealiazadas);
                    ...
                    if ($arrayComprasRealiazadas != null) {
                        foreach ($arrayComprasRealiazadas as $compraRealizada) {
                            ...
                            <tr>
                                ...
                                <td>' . $compraRealizada->getCompraEstadoTipo()->getcompraEstadoTipoDescripcion() . '</td>
                                <td class="d-none">' . $compraRealizada->getcompraEstadoFechaIni() . '</td>
                                <td class="d-none">' . $compraRealizada->getcompraEstadoFechaFin() . '</td>
