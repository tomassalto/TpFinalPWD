$(document).ready(function() {
    $('form').submit(function(e) {
        ...
        let contra=document.querySelector('#usuarioPassAnterior').value;
        let contraNueva=document.querySelector('#usuarioPassNueva').value;
        if(contraNueva.length>0){
            contraNueva = hex_md5(contraNueva).toString();
            document.querySelector('#usuarioPassNueva').value = contraNueva;
            document.querySelector('#usuarioPassNueva').name='usuarioPass';
        }else{
            document.querySelector('#usuarioPassAnterior').value=contra;
            document.querySelector('#usuarioPassAnterior').name='usuarioPass';
        }
