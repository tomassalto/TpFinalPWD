                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $arrayUsers[$i]->getusuarioNombre() ?></td>
                            <td> <?php echo $arrayUsers[$i]->getusuarioMail() ?> </td>
                            <td> <?php $msn = "-";
                            ...
                            <td class="text-center"> <?php echo $arrayUsers[$i]->getusuarioDeshabilitado() == NULL ? "NO" : $arrayUsers[$i]->getusuarioDeshabilitado(); ?> </td>
                            <td>
                                <form method='post' action='actualizarLogin.php' id="'<?php echo $arrayUsers[$i]->getIdUsuario() ?>">
                                    ...
                                    <?php echo $arrayUsers[$i]->getusuarioDeshabilitado() == NULL ?
