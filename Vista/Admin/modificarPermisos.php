...
<main class="w-50 m-auto mt-5 text-center">
    ...
    <div class="col-10 col-lg-7">
        <label for="menuNombre" class="form-label mt-2">Nombre de Menu</label>
        <input type="text" class="form-control" pattern="[a-zA-Z]+\s?[a-zA-Z]*\s?[a-zA-Z]*\s?[a-zA-Z]*\s?[a-zA-Z]*"
                name="menuNombre" value="<?php echo $menuModificar[0]->getmenuNombre()?>" required>
    </div>
    <div class="col-10 col-lg-7">
    ...
    <div class="col-10 col-lg-7">
    <label for="menuDescripcion" class="form-label mt-2">Ruta Relativa</label>
        <input type="text" class="form-control" pattern="(..\/)([a-zA-Z0-9_\-]+)(\/[a-zA-Z0-9_\-]+)\.php"
                name="menuDescripcion" value="<?php echo $menuModificar[0]->getmenuDescripcion()?>" required>
    </div>
