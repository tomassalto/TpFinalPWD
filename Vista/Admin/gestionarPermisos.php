        ...
        <table class="table table-dark table-hover p-5">
            ...
            <?php
                foreach($permisos as $permiso){
                    ?>
                    <tr> 
                    <th scope="row" class="text-center"><?php echo $permiso->getMenu()->getmenuNombre()?></th>
                    <td><?php echo $permiso->getMenu()->getmenuDescripcion() ?></td>
                    <td class="text-center"> <?php echo $permiso->getRol()->getIdRol() ?> </td>
                    <td class="text-center"> <?php echo $permiso->getRol()->getRolDescripcion()  ?> 
                    </td>
                    <td class="text-center"> <?php echo $permiso->getMenu()->getmenuDeshabilitado()==NULL?"NO":$permiso->getMenu()->getmenuDeshabilitado()?>
                    </td>
                    <td class="text-center">
                        ...
                        <?php echo $permiso->getMenu()->getmenuDeshabilitado()==NULL?
    ...
    <form class="row justify-content-center needs-validation" id="formNuevoPermiso"
        ...
        <div class="col-10">
            ...
            <div class="col-lg-7 col-12 mt-2">
                ...
                name="menuNombre" minlength="3" class="form-control text mt-2" required>
            ...
            <div class="col-lg-7 col-12 mt-2">
                ...
                <input type="text" pattern="(..\/)([a-zA-Z0-9_\-]+)(\/[a-zA-Z0-9_\-]+)\.php" name="menuDescripcion" minlength="10" 
            ...
            <div class="col-lg-7 col-12 mt-2">
                ...
                foreach($permisos as $permiso){
                    ?>
                    <option value="<?php echo $permiso->getMenu()->getIdMenu()?>"> <?php echo $permiso->getMenu()->getmenuNombre()?></option>
                    <?php
                }
                ?>
                </select>
