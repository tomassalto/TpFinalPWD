...
<main class="w-50 m-auto mt-5 text-center">
    ...
    <div class="col-10 col-lg-7">
        ...
        <input type="text" class="form-control" placeholder="Username" pattern="[a-zA-Z]+\s?[0-9]*" minlength="3"
                name="usuarioNombre" id="usuarioNombre" value="<?php echo $usuarioModificar[0]->getUsuarioNombre()?>" required>
    ...
    <div class="col-10 col-lg-7">
    <label for="usuarioNombre" class="form-label mt-2">MAIL</label>
        <input type="text" class="form-control" placeholder="Mail" pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*\.([a-z]{3})(\.[a-z]{2})*$"
                name="usuarioMail" id="usuarioMail" value="<?php echo $usuarioModificar[0]->getUsuarioMail()?>" required>
    </div>
    <div class="col-10 col-lg-7">
    <label for="usuarioPass" class="form-label mt-2">CONTRASEÑA</label>
        <input type="password" class="form-control" placeholder="***********" id="usuarioPassNueva">
        <input type="password" class="form-control d-none"
            id="usuarioPassAnterior" value="<?php echo $usuarioModificar[0]->getUsuarioPass()?>">
            <div class="invalid-feedback">
