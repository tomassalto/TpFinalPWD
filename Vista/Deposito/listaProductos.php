        ...
        <div class="container-fluid" style="margin-bottom: 19%">
                ...
                <div class="mb-3">
                    ...
                    ?>
                        ...
                        foreach ($arrayProductos as $producto) {
                            ...
                            echo '<td>' . $producto->getproductoNombre() . '</td>';
                            echo '<td>' . $producto->getproductoCantStock() . '</td>';
                            echo '<td>' . $producto->getproductoUrlImagen() . '</td>';
                            echo '<td>' . $producto->getproductoPrecio() . '</td>';
            ...
            <div class="container-fluid col-md-10 text-white mt-5 d-none" id='editarProducto'>
                ...
                <div class="mb-3">
                    ...
                    <form id='form-editar' method="post" action="../Accion/ActualizarProductos.php" class="needs-validation row text-white justify-content-center col-12" novalidate>
                        <table class="table table-striped table-dark">
                            <tr>
                                <th>ID</th>
                                <th>Nombre</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-lg-7 col-12 "><input type="text" style="width: 150px;" name="productoNombre" required></input>
                                ...
                                <td>
                                    <div class="col-lg-7 col-12"><input type="number" min="0" name="productoCantStock" style="width: 100px;" required></input>
                                        <div class="invalid-feedback">
                                ...
                                <td>
                                    <div class="col-lg-7 col-12"><input type="url" name="productoUrlImagen" required></input>
                                        <div class="invalid-feedback">
                                            Ingrese una url!</div>
                                        <div class="valid-feedback">
                                            Correcto!</div>
                                ...
                                <td>
                                    <div class="col-lg-7 col-12 "><input type="number" style="width: 100px;" min="0" name="productoPrecio" required></input>
                                        <div class="invalid-feedback">
